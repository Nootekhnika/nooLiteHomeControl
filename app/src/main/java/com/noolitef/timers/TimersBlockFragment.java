...
public class TimersBlockFragment extends DialogFragment {
    public TimersBlockFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(R.layout.fragment_timers_block, null);
