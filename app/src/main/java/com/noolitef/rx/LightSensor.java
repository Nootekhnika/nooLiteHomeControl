...
public class LightSensor {
    ...
    public LightSensor(int channel, boolean batteryLow, boolean dark, int roomID, String room, String name, int lastUpdateYear, int lastUpdateMonth, int lastUpdateDay, int lastUpdateWeekDay, int lastUpdateHour, int lastUpdateMinute, int lastUpdateSecond) {
